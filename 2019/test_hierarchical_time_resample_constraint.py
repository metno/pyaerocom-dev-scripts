...
class TimeResampler(object):
    ...
    def _gen_idx(self, from_ts_type, to_ts_type, sampling_constraints):
        ...
        for i in range(start+1, stop+1):
            to = valid[i]
            if to in sampling_constraints and last_from in sampling_constraints[to]:
                
                min_num = sampling_constraints[to][last_from]
                last_from = to
    ...
    def resample(self, to_ts_type, input_data=None, from_ts_type=None, 
                 ...
                 sampling_constraints=None, **kwargs):
        """Resample input data
...
stat = data.to_station_data('Jungfrau*')
